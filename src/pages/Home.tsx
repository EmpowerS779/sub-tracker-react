...
import { ArrowRight, Bell, Calendar, PieChart } from 'lucide-react';
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  ...
                  <span className="block text-indigo-600">subscriptions</span>
                </h1>
          ...
          <div className="mt-10">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
              <FeatureCard
                ...
                description="Get notified before renewals and payments are due"
              />
              <FeatureCard
                icon={<Calendar className="h-6 w-6" />}
                title="Calendar View"
                description="Visualize your subscription timeline"
              />
              <FeatureCard
                icon={<PieChart className="h-6 w-6" />}
                title="Spending Analytics"
                description="Track and analyze your subscription spending"
              />
            </div>
          </div>
        </div>
